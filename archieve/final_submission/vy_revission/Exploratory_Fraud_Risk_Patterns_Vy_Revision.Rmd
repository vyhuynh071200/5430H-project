...
generates each figure during rendering. Supporting functions are defined directly in the R Markdown source.
No static screenshot is used as an analytical result.
